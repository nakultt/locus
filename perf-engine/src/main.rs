...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route("/api/users/{user_id}/settings/gemini-key", post(handler::settings::update_settings).get(handler::settings::get_gemini_key).delete(handler::settings::delete_gemini_key))
