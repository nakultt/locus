...
from app.services.pipeline import comms_log, work_item
...
async def refresh(
    ...
    *,
    ...
    try:
        ...
        from app.services.pipeline.pr_agent import export_to_google_doc
...
async def ensure_for_ticket(
    ...
    *,
    ...
    try:
        ...
        # startup.
        from app.services.pipeline.pr_agent import create_google_doc
