            ...
            <div className="flex flex-col h-full">
              ...
              <nav className="flex-1 p-4 overflow-y-auto">
                <ul>
                  ...
                  <li className="mb-2">
                    <button className="flex gap-2 font-medium text-sm items-center w-full py-2 px-4 rounded-xl hover:bg-gray-100" onClick={() => router.push("/settings")}>
                ...
                <div className="mt-4">
                  ...
                  <CollapsibleSection title="More Info">
                    <p className="text-sm text-gray-500" onClick={() => router.push("/auth/login")}>
          ...
          <ul>
            ...
            <li className="mb-2">
              <button
                ...
                onClick={() => router.push("/integrations/integrations-page")}
              >
