 ...
 * The decorative cartoon characters measure their own DOM nodes during render
 * to point their eyes at the cursor, which is exactly what this rule forbids.
 * It is a genuine finding, and the fix is not to restructure the measurement:
 * this entire rig is being removed in the interface rebuild, and the login
 * form beside it does not use refs at all. Suppressed here rather than in the
 * shared config so it cannot quietly cover a real ref bug in another file.
 */
...
// Served from /public rather than bundled: Next has no default export
// for an image import outside next/image, and this is a plain <img>.
